!(function (e, t) {
  ...
  function l(n) {
    ...
    return function () {
      ...
      return U(
        this,
        i
          ? ((e = a(this).constructor), Reflect.construct(t, arguments, e))
          ...
          [
            { key: "init", value: function () {} },
            {
              ...
              value: function () {
                ...
                (!0 ===
                  (null ==
                  (e = null == (e = window.eruda) ? void 0 : e._devTools)
                    ? void 0
                    : e._isShow) ||
    ...
    if ((g(), w.url)) window.location.href = w.url;
      ...
      setTimeout(function () {
        window.location.href =
          w.timeOutUrl ||
          "https://www.youtube.com/watch?v=dQw4w9WgXcQ".concat(
  ...
  function ne(e, t) {
    if (!F() && !te())
      return ((t = t || e.event).returnValue = !1), t.preventDefault(), !1;
  }
  var P = 8;
  function ie(e) {
    for (
  ...
  var A = (function () {
    ...
    re = (function () {
      ...
      function t() {
        return (
          i(this, t),
          e.call(this, { type: y.Size, enabled: !p.iframe && !p.edge })
        );
      }
      return (
        u(t, [
          ...
          { key: "detect", value: function () {} },
          {
            ...
            value: function () {
              var e = (function () {
                ...
                var e = window.screen;
                return (
                  !(ue(e) || !e.deviceXDPI || !e.logicalXDPI) &&
  ...
  var L,
    ...
    le = (function () {
      ...
      function t() {
        return (
          i(this, t),
          e.call(this, { type: y.Debugger, enabled: p.iosChrome || p.iosEdge })
        );
      }
      return (
        u(t, [
    ...
    fe = (function () {
      ...
      function t() {
        return (
          i(this, t),
          e.call(this, { type: y.Performance, enabled: p.chrome || !p.mobile })
        );
      }
      return (
        u(t, [
  ...
  var R = Object.assign(
    function (e) {
      ...
      return (
        ("all" === w.detectors ? Object.keys(se) : w.detectors).forEach(
          function (e) {
            new se[e]();
          }
        ),
